...
const float R = 0.53784; // value depends on gain
...
void setRGB_LED(bool on) {
  ...
  // Need physical connection to sensor, cant do through multplex 
  selectChannel(2);
...
void loop() {
  ...
  // still some weirdness - need to investigate this function further
